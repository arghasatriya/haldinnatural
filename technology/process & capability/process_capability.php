...
<!----------------------------------------------------- PROCESS CAPABILITY AREA ------------------------------------------------------->
    <section  class="service-area section-padding bg-white" id="technology">
        <div class="container">
            ...
            <?php
                $qrecord = "SELECT * FROM `t_process_capabilities` WHERE id = 2";
                $rrecord = mysqli_query($konek, $qrecord);
                $rwrecord = mysqli_fetch_array($rrecord);
                {
            ?> 
                    ...
                    <div class="col-md-7 mt-50">
                        <div class="left_question_inner">
                            ...
                            <?php
                                $qrecord = "SELECT * FROM `t_process_capabilities` WHERE id = 3";
                                $rrecord = mysqli_query($konek, $qrecord);
                                $rwrecord = mysqli_fetch_array($rrecord);
                                {
                            ?> 
                            ...
                            <?php
                                $qrecord = "SELECT * FROM `t_process_capabilities` WHERE id = 4";
                                $rrecord = mysqli_query($konek, $qrecord);
                                $rwrecord = mysqli_fetch_array($rrecord);
                                {
                            ?> 
                            ...
                            <?php
                                $qrecord = "SELECT * FROM `t_process_capabilities` WHERE id = 5";
                                $rrecord = mysqli_query($konek, $qrecord);
                                $rwrecord = mysqli_fetch_array($rrecord);
                                {
                            ?> 
                    ...
                    <div class="col-md-5 mt-50">
                        <div class="right_question_img">
                            <img <?php echo 'src="img/technology/process capabilites/'.$rwrecord['photo'].'"';?>" class="img-responsive" alt="">
                        </div>
                    </div>
