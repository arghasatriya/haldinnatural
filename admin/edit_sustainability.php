     ...
     if(isset($_POST["Update2"]) && !empty($_FILES["slider1"]["name"]))
    {
        ...
        if(in_array($fileType, $allowTypes))
        {
            ...
            // Upload file to server
                ...
                $insert = $konek->query("UPDATE t_sustainability SET point1_icon = ('$fileName'), uploaded_on = NOW() WHERE `t_sustainability`.`id` = '".$_GET['id']."'");
        ...
        <body>
            ...
            <div id="right-panel" class="right-panel">
                ...
                <?php include "top_menu.php"?>
                 ...
                 <?php
                    $id=$_GET['id'];
                    $qrecord = "SELECT * FROM t_sustainability where id='$id'";
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="mx-auto d-block">
                                                    <img class="rounded-circle mx-auto d-block" <?php echo 'src="../img/our responsibility/sustainability/'.$rwrecord['point1_icon'].'"';?> height="148" width="157" style="text-align: center;" alt="Card image cap">
