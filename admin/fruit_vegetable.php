<?php
    ...
    if ($_POST[Update])
    {
        ...
        $qupdate = "    UPDATE `t_product` SET 
                        product = '".$_POST['title']."', 
                        story = '".$_POST['story']."', 
                        content1 = '".$_POST['point1_content']."',
                        content2 = '".$_POST['point2_content']."'
                        WHERE `t_product`.`id` = 11";
        ...
        echo "<script type='text/javascript'>
             alert('Success!')
             window.location='fruit_vegetable.php';
             </script>";
    }
...
if(isset($_POST["Update2"]) && !empty($_FILES["banner_photo"]["name"]))
    {
        ...
        if(in_array($fileType, $allowTypes))
        {
            ...
            // Upload file to server
                ...
                $insert = $konek->query("UPDATE t_product SET banner_photo = ('$fileName') WHERE `t_product`.`id` = 11");
        ...
        if(in_array($fileType2, $allowTypes))
        {
            ...
            // Upload file to server
                move_uploaded_file($_FILES["slider1"]["tmp_name"], $targetFilePath2);
                    // Insert image file name into database
                $insert = $konek->query("UPDATE t_product SET slider1 = ('$fileName2') WHERE `t_product`.`id` = 11");
        ...
        if(in_array($fileType3, $allowTypes))
        {
            ...
            // Upload file to server
                move_uploaded_file($_FILES["slider2"]["tmp_name"], $targetFilePath3);
                    // Insert image file name into database
                $insert = $konek->query("UPDATE t_product SET slider2 = ('$fileName3') WHERE `t_product`.`id` = 11");
        ...
        if(in_array($fileType4, $allowTypes))
        {
            ...
            // Upload file to server
                move_uploaded_file($_FILES["slider2"]["tmp_name"], $targetFilePath4);
                    // Insert image file name into database
                $insert = $konek->query("UPDATE t_product SET slider3 = ('$fileName4') WHERE `t_product`.`id` = 11");
        ...
        <body>
            ...
            <div id="right-panel" class="right-panel">
                ...
                <?php include "top_menu.php"?>
                 ...
                 <?php
                    $qrecord = "SELECT * FROM `t_product` WHERE id = '11'";
                                                ...
                                                <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                                                    <div class="tab-pane fade show active" id="point1" role="tabpanel" aria-labelledby="custom-nav-home-tab">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="point1_content" type="text" id="editor3" rows="4" class="form-control" aria-required="true" aria-invalid="false"><?php echo $rwrecord['content1'];?></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="tab-pane fade" id="point2" role="tabpanel" aria-labelledby="custom-nav-profile-tab">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="point2_content" type="text" id="editor4" rows="4" class="form-control" aria-required="true" aria-invalid="false"><?php echo $rwrecord['content2'];?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
