<?php
    ...
    // File upload path
    $targetDir = "../img/technology/solutions applications/";
    ...
    if ($_POST[Update])
    {
        ...
        $qupdate = "UPDATE `t_solutions_applications` SET 
                        ...
                        WHERE `t_solutions_applications`.`id` = 1";
     ...
     if(isset($_POST["Update2"]) && !empty($_FILES["file"]["name"]))
    {
        ...
        if(in_array($fileType, $allowTypes))
        {
            ...
            // Upload file to server
                ...
                $insert = $konek->query("UPDATE t_solutions_applications SET photo = ('$fileName'), uploaded_on = NOW() WHERE `t_solutions_applications`.`id` = 1");
        ...
        if(in_array($fileType2, $allowTypes))
        {
            ...
            // Upload file to server
                move_uploaded_file($_FILES["banner_photo"]["tmp_name"], $targetFilePath2);
                    // Insert image file name into database
                $insert = $konek->query("UPDATE t_solutions_applications SET banner_photo = ('$fileName2'), banner_uploaded_on = NOW() WHERE `t_solutions_applications`.`id` = 1");
        ...
        <body>
            ...
            <div id="right-panel" class="right-panel">
                ...
                <?php include "top_menu.php"?>
                 ...
                 <?php
                    $qrecord = "SELECT * FROM t_solutions_applications";
                                        ...
                                        ?> 
                                            ...
                                            <div class="card-body">
                                                <div class="mx-auto d-block">
                                                    ...
                                                    <img class="mx-auto d-block" <?php echo 'src="../img/technology/solutions applications/'.$rwrecord['banner_photo'].'"';?> height="auto" width="auto" style="text-align: center;" alt="Card image cap">
                                                ...
                                                <div class="col-md-12">
                                                    <div style="overflow-x:auto;">
                                                        <table class="table table-striped">
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                    $qrecord1 = "SELECT * FROM t_solutions_applications WHERE id IN (2,3,4,5)";
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="edit_solutions_application.php?id=<?php echo $rwrecord1['id']; ?>">
                                        ...
                                        ?> 
                                            ...
                                            <div class="card-body">
                                                <div class="mx-auto d-block">
                                                    ...
                                                    <img class="mx-auto d-block" <?php echo 'src="../img/technology/solutions applications/'.$rwrecord['photo'].'"';?> height="auto" width="auto" style="text-align: center;" alt="Card image cap">
