<?php
    ...
    // File upload path
    $targetDir = "../img/our responsibility/reduce carboon footprint/";
    ...
    if ($_POST[Update])
    {
        $date=date("Y-m-d");
        $time=date("H:i:s");
        $qupdate = "    UPDATE `t_reduce_carbon_footprint` SET 
                        title = '".$_POST['title1']."',
                        content = '".$_POST['content1']."'
                        WHERE `t_reduce_carbon_footprint`.`id` = 1";
    ...
    if(isset($_POST["Update2"]) && !empty($_FILES["banner_photo"]["name"]))
    {
        ...
        if(in_array($fileType, $allowTypes))
        {
            ...
            // Upload file to server
                ...
                $insert = $konek->query("UPDATE t_reduce_carbon_footprint SET banner_photo = ('$fileName'), banner_uploaded_on = NOW() WHERE `t_reduce_carbon_footprint`.`id` = 1");
        ...
        if(in_array($fileType2, $allowTypes))
        {
            ...
            // Upload file to server
                move_uploaded_file($_FILES["photo"]["tmp_name"], $targetFilePath2);
                    // Insert image file name into database
                $insert = $konek->query("UPDATE t_reduce_carbon_footprint SET photo = ('$fileName2'), uploaded_on = NOW() WHERE `t_reduce_carbon_footprint`.`id` = 1");
        ...
        <body>
            ...
            <div id="right-panel" class="right-panel">
                ...
                <?php include "top_menu.php"?>
                 ...
                 <?php
                    $qrecord = "SELECT * FROM t_reduce_carbon_footprint";
                                ...
                                <div class="col-md-12">
                                        ...
                                        ?> 
                                            ...
                                            <div class="card-body">
                                                <div class="mx-auto d-block">
                                                    <img class="mx-auto d-block" <?php echo 'src="../img/our responsibility/reduce carboon footprint/'.$rwrecord['banner_photo'].'"';?> height="auto" width="auto" style="text-align: center;" alt="Card image cap">
                                                ...
                                                <div class="col-md-12">
                                                    <div style="overflow-x:auto;">
                                                        <table class="table table-striped">
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                    $qrecord1 = "SELECT * FROM t_reduce_carbon_footprint WHERE id IN (2,3)";
                                                                ...
                                                                ?> 
                                                                <tr>
                                                                    <td class="text-center"> <img width="40" height="40" class="mx-auto d-block" <?php echo 'src="../img/our responsibility/reduce carboon footprint/'.$rwrecord1['point1_icon'].'"';?>></td>
                                                                    <td class="text-center"><?php echo $rwrecord1['point1_title'];?></td>
                                                                    <td>
                                                                        <a href="edit_reduce_carbon_footprint.php?id=<?php echo $rwrecord1['id']; ?>">
                                    ...
                                    <div class="card">
                                        ...
                                        ?> 
                                            ...
                                            <div class="card-body">
                                                <div class="mx-auto d-block">
                                                    <img class="mx-auto d-block" <?php echo 'src="../img/our responsibility/reduce carboon footprint/'.$rwrecord['photo'].'"';?> height="auto" width="auto" style="text-align: center;" alt="Card image cap">
