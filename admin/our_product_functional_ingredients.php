    ...
    if(isset($_POST["Update"]) && !empty($_FILES["file"]["name"]))
    {
        ...
        if(in_array($fileType, $allowTypes))
        {
            ...
            // Upload file to server
                ...
                $insert = $konek->query("UPDATE t_our_product SET file_name = ('$fileName'), uploaded_on = NOW() WHERE `t_our_product`.`id` = 2");

                if($insert)
                {
                   echo "  <script type='text/javascript'>
                             alert('Success!')
                             window.location='our_product_functional_ingredients.php';
                             </script>";
                }
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <?php
                                                  $query = "SELECT * FROM t_our_product WHERE id = 2";  
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row form-group">
                                                            ...
                                                            <div class="col-12 col-md-9">
                                                                 ...
                                                                 <p class="mt-2 mb-1" style="font-size: 11px;"><i>Image Resolution 900 x 900</i></p>
                                                            </div>
                                                        </div>
